...
function startTimer1() {
  startTime1 = Date.now() - time1;
  interval1 = setInterval(() => {
    time1 = Date.now() - startTime1;
    timer1.html(formatTime(time1));
  }, 10);
}
...
function startTimer2() {
  startTime2 = Date.now() - time2;
  interval2 = setInterval(() => {
    time2 = Date.now() - startTime2;
    timer2.html(formatTime(time2));
  }, 10);
}
